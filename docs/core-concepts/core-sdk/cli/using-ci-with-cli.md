...
you want to automate the installation through some way. The automation, ideally, should not require administrative 
...
If using installers that require administrative privileges is not something that bothers you, native installers for 
...
Ubuntu or `yum` for CentOS, or using the packages themselves (i.e. DEB or RPM). Former would require setting up the 
...
install them if the operating system you are installing on already doesn't have them. You can see the list of pre-requisites 
